...
add_action('admin_print_styles', 'dt_theme_admin_panel_styles');
...
function dt_theme_admin_panel_styles() {
	global $wp_version;
...
add_action('admin_head-toplevel_page_parent', 'dt_theme_admin_print_scripts');
function dt_theme_admin_print_scripts() {
	echo "<script type=\"text/javascript\">
	//<![CDATA[
